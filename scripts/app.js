...
// we will return Math.sqrt(n) to get the square root of (n)
// then we will use the result of that with a modulo % operation with 1
// if n is a perfect square then the modulo with a 1 will result in 0
// if the result of the modulo is 0 then its true, other wise its false
function isSquare(n){
